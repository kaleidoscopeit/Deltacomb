...
#define CUSTOM_MACHINE_NAME "DELTACOMB"
...
#define DELTA
  ...
  //#define DELTA_HEIGHT 274.00 // get this value from auto calibrate
  //#define DELTA_HEIGHT 274.00 - 16.00 // get this value from auto calibrate
  #define DELTA_HEIGHT 274.00 - 45.00 // simple effector
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 135.0
  #define DELTA_EFFECTOR_OFFSET 26.50  // Deltacomb Original Head
  #define DELTA_CARRIAGE_OFFSET 19.70
 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 162 }  // default steps per unit for Kossel (GT2, 20 tooth)
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 100, 162 }  // default steps per unit for Kossel (GT2, 16 tooth)
...
#define DEFAULT_ZJERK                 30.0 // Must be same as XY for delta
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ABL_PROBE_PT_1_X -78
  #define ABL_PROBE_PT_1_Y -45
  #define ABL_PROBE_PT_2_X 78
